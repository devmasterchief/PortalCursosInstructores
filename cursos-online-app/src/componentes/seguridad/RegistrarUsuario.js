            ...
            <form style={style.form}>
                <Grid container spacing={2}>
                    <Grid item xs={12} md={12}>
                        <TextField name='NombreCompleto' value={usuario.NombreCompleto} onChange={ingresarValoresMemoria} type='text' variant='outlined' fullWidth label='Ingrese nombre y apellidos'/>
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <TextField name='Email' value={usuario.Email} onChange={ingresarValoresMemoria} type='text' variant='outlined' fullWidth label='Ingrese su email'/>
                    </Grid>
                    <Grid item xs={12} md={6}>
